...
const CartBar = () => {
  ...
  if (
        itemCount === 0 ||
        ['/cart', '/profile', '/checkout', '/checkout-wholesale','/signup', '/login', '/about', '/contact','/edit-profile','/complete-account', '/account-details', '/SignupForm', '/wallet', '/help','/forgot-password','/reset-password'].includes(location.pathname)
        ) return null;
